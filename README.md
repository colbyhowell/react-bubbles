...
- [ ] Explain what a token is used for.
      ...
      A token is a piece of data that is stored locally that allows for the user to interact with a server. It essentially verifies the user.

- [ ] What steps can you take in your web apps to keep your data secure?

      You can use tokens, Private Routes, session state, local state, and more. There are a lot of options for developers these days.

- [ ] Describe how web servers work.

      Web servers are a series of "stacks" that contain a data for a website. The data can include site files, data files, and more. It is connected to via the internet, or sometimes via a local network.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

      Create, Read, Update, and Delete. You can use axios to get, create, change, or delete information within a web server or local server.
